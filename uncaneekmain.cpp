...
void autonomous() {
    ...
    switch(current_auton_selection){
        ...
        case 8: //blue negative sham
            ...
            chassis.turnToHeading(-180, 300);
            chassis.moveToPoint(42, -7, 1000, { .forwards = false, .minSpeed = 100});
            chassis.moveToPoint(39, -20, 900);
            chassis.turnToHeading(270, 750);
            chassis.moveToPoint(5, -26, 900);
            chassis.turnToHeading(190, 750);
            chassis.waitUntilDone();
            intakespin = false;
            doink.set_value(true);
            chassis.moveToPoint(-7, -40, 1000, {.maxSpeed = 70});
            chassis.turnToHeading(100, 900);
            chassis.waitUntilDone();
            doink.set_value(false);
            chassis.turnToHeading(190, 750);
            chassis.waitUntilDone();
            intakespin = true;
            chassis.moveToPoint(-9, -48, 1000);
